        ...
        confirmedSnapshot.forEach((doc) => {
          ...
          if (confirmedData.userId === user.uid) {
            ...
            orders.push({
              ...
              ...confirmedData,
              date:
                confirmedData.confirmedAt?.toDate() ||
                confirmedData.timestamp?.toDate() ||
                new Date(),
              buyerName:
    ...
    <div className="space-y-6 bg-[#FEFDF4] min-h-screen w-full">
      ...
      <div className="bg-[#FAF6E9] p-6 rounded-lg border border-[#C8C0C0]">
        <div className="flex justify-between items-center mb-4">
          <h4 className="text-xl font-semibold text-[#02542d]">
            Address Details
          </h4>
          <button
            onClick={() =>
              isEditingAddress ? handleCancelEdit() : setIsEditingAddress(true)
            }
      ...
      {/* Order History */}
      <div className="bg-[#FAF6E9] p-6 rounded-lg border border-[#C8C0C0]">
        <h4 className="text-xl font-semibold text-[#02542d] mb-4">
          Order History
        </h4>
            ...
            {orderHistory.map(
              (order) => (
                ...
                (
                  <div
                    key={order.id}
                    className="border-b border-[#C8C0C0] pb-4 last:border-b-0"
                  >
                    <div className="space-y-2">
