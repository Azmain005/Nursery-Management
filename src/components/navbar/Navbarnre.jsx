      ...
      <div className="navbar bg-[#faf6e9] border-b-2 border-[#3e5931]">
        ...
        <div className="flex-none mr-5">
          ...
          <div className="dropdown dropdown-end">
            ...
            >
              <li>
                <NavLink to='/profile' className="justify-between text-white text-sm hover:text-black">
              ...
              <li>
                <NavLink to='settings' className="text-white text-sm hover:text-black">
                  <div className="flex justify-center items-center gap-1">
              ...
              <li>
                <a className="btn bg-red-400 text-sm hover:bg-red-500 border-none shadow-none mt-2">
                  Logout
                </a>
              </li>
            </ul>
